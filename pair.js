...
async function uploadCredsToMega(credsPath) {
    try {
        const storage = await new Storage({
            email: 'alixexadron7@gmail.com', // Your Mega A/c Email Here
            password: '@Alix54321-M' // Your Mega A/c Password Here
        }).ready;
            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'DUBED-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
